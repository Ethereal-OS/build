...
function lunch()
{
    ...
    then
        # if we can't find a product, try to grab it off the EtherealOS-Devices GitHub
        T=$(gettop)
        cd $T > /dev/null
...
function eosupload() {
    ...
    destination="${sf_username}@frs.sourceforge.net:/home/frs/project/ethereal-os/$target_device/"
